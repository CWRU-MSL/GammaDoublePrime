...
ellipse=np.load(TEMP_PATH + 'ellipse.npy')
...
np.savetxt("img/NASA-2/Results/ellipse_dia.csv", list_ellipse)
...
np.save(TEMP_PATH + 'GDP_array.npy',filled)


#plt.savefig(RESULT_PATH + '05-Final_gamma_double.png', dpi = 300)
