...
contourevidence=np.load(TEMP_PATH + 'contourest.npy', allow_pickle=True).item()
...
# plt.show()
#plt.savefig(RESULT_PATH + '03-Ellipsefitting.png', dpi = 300)
np.save(TEMP_PATH + 'contours.npy',stats)
